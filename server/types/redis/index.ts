...
export type T_RedisClientType = RedisClientType<
  {
    graph: {
      ...
      configSet: typeof import("@redis/graph/dist/commands/CONFIG_SET"); // Rate limiting
      // Rate limiting
      ...
      slowLog: // Set security headers
      typeof import("@redis/graph/dist/commands/SLOWLOG");
    };
    json: {
    ...
    ft: {
      ...
      alter: typeof import("@redis/search/dist/commands/ALTER"); //report to an error handler, for now we will log our the result //report to an error handler, for now we will log our the result
      ...
      //Get the historical currency value for each trend and append to the original trend.
      aggregate: typeof import("@redis/search/dist/commands/AGGREGATE");
